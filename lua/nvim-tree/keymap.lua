...
function M.on_attach_default(bufnr)
  ...
  vim.keymap.set("n",          "gp",             api.fs.paste_from_clipboard_copying, opts("Paste From Cliboard - Copying"))
  vim.keymap.set("n",          "gx",             api.fs.paste_from_clipboard_cutting, opts("Paste From Cliboard - Cutting"))
