...
function M.on_attach_default(bufnr)
  ...
  vim.keymap.set({ "n", "x" }, "bgy",            api.fs.copy.absolute_path_with_protocol, opts("Copy Absolute Path With Protocol"))
  ...
  vim.keymap.set("n",          "gp",             api.fs.paste_with_protocol,              opts("Paste With Protocol"))
