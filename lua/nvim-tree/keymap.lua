...
function M.on_attach_default(bufnr)
  ...
  vim.keymap.set("n",          "gp",             api.fs.paste_from_register_copying, opts("Paste From Register - Copying"))
  vim.keymap.set("n",          "gx",             api.fs.paste_from_register_cutting, opts("Paste From Register - Cutting"))
