...
Api.config.mappings.active = wrap(function()
  notify.error "api.config.mappings.active has been replaced by config.mappings.get_keymap"
end)

Api.config.mappings.default = function()
  notify.error "api.config.mappings.default has been replaced by config.mappings.get_keymap_default"
end
