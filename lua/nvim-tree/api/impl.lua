...
function M.hydrate_post_setup(api)
  ...
  api.node.open.edit                           = _n(function(n, opts) require("nvim-tree.actions.node.open-file").edit(n, opts) end)
  api.node.open.horizontal                     = _n(function(n, opts) require("nvim-tree.actions.node.open-file").horizontal(n, opts) end)
  api.node.open.horizontal_no_picker           = _n(function(n, opts) require("nvim-tree.actions.node.open-file").horizontal_no_picker(n, opts) end)
  api.node.open.no_window_picker               = _n(function(n, opts) require("nvim-tree.actions.node.open-file").no_window_picker(n, opts) end)
  api.node.open.preview                        = _n(function(n, opts) require("nvim-tree.actions.node.open-file").preview(n, opts) end)
  api.node.open.preview_no_picker              = _n(function(n, opts) require("nvim-tree.actions.node.open-file").preview_no_picker(n, opts) end)
  api.node.open.replace_tree_buffer            = _n(function(n) require("nvim-tree.actions.node.open-file").replace_tree_buffer(n) end)
  api.node.open.tab                            = _n(function(n, opts) require("nvim-tree.actions.node.open-file").tab(n, opts) end)
  ...
  api.node.open.vertical                       = _n(function(n, opts) require("nvim-tree.actions.node.open-file").vertical(n, opts) end)
  api.node.open.vertical_no_picker             = _n(function(n, opts) require("nvim-tree.actions.node.open-file").vertical_no_picker(n, opts) end)
