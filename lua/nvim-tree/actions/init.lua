...
local M = {
  mappings = {
    { key = { "<CR>", "o", "<2-LeftMouse>" }, action = "edit", desc = "open a file or folder; root will cd to the above directory" },
    { key = "<C-e>", action = "edit_in_place", desc = "edit the file in place, effectively replacing the tree explorer" },
    { key = "O", action = "edit_no_picker", desc = "same as (edit) with no window picker" },
    { key = { "<C-]>", "<2-RightMouse>" }, action = "cd", desc = "cd in the directory under the cursor" },
    ...
    { key = "<", action = "prev_sibling", desc = "navigate to the previous sibling of current file/directory" },
    { key = ">", action = "next_sibling", desc = "navigate to the next sibling of current file/directory" },
    ...
    { key = "<Tab>", action = "preview", desc = "open the file as a preview (keeps the cursor in the tree)" },
    { key = "K", action = "first_sibling", desc = "navigate to the first sibling of current file/directory" },
    { key = "J", action = "last_sibling", desc = "navigate to the last sibling of current file/directory" },
    { key = "I", action = "toggle_git_ignored", desc = "toggle visibility of files/folders hidden via |git.ignore| option" },
    { key = "H", action = "toggle_dotfiles", desc = "toggle visibility of dotfiles via |filters.dotfiles| option" },
    { key = "U", action = "toggle_custom", desc = "toggle visibility of files/folders hidden via |filters.custom| option" },
    { key = "R", action = "refresh", desc = "refresh the tree" },
    { key = "a", action = "create", desc = "add a file; leaving a trailing `/` will add a directory" },
    ...
    { key = "<C-r>", action = "full_rename", desc = "rename a file and omit the filename on input" },
    ...
    { key = "p", action = "paste", desc = "paste from clipboard; cut clipboard has precedence over copy; will prompt for confirmation" },
    ...
    { key = "gy", action = "copy_absolute_path", desc = "copy absolute path to system clipboard" },
    { key = "[c", action = "prev_git_item", desc = "go to next git item" },
    { key = "]c", action = "next_git_item", desc = "go to prev git item" },
    { key = "-", action = "dir_up", desc = "navigate up to the parent directory of the current file/directory" },
    { key = "s", action = "system_open", desc = "open a file with default system application or a folder with default file manager, using |system_open| option" },
    { key = "f", action = "live_filter", desc = "live filter nodes dynamically based on regex matching." },
    ...
    { key = ".", action = "run_file_command", desc = "enter vim command mode with the file the cursor is on" },
    { key = "<C-k>", action = "toggle_file_info", desc = "toggle a popup with file infos about the file under the cursor" },
