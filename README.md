...
require('nvim-tree').setup{
  ...
  tab_open = 1, --0 by default, will open the tree when entering a new tab and the tree was previously open
  auto_resize = 0, --1 by default, will resize the tree to its saved width when opening a file
  ...
  disable_window_picker = 1, --0 by default, will disable the window picker.
  ...
  update_cwd = 1, --0 by default, will update the tree cwd when changing nvim's directory (DirChanged event). Behaves strangely with autochdir set.
