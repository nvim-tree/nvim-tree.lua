...
local modules = {
  ...
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/view.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/renderer.lua", },
  ...
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/update_focused_file.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/system_open.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/git.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/diagnostics.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/modified.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/filters.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/live_filter.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/filesystem_watchers.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/actions.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/trash.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/tab.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/notify.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/help.lua", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/ui.lua",                  name = "UI", },
  { helptag = "nvim-tree-config-YYY",                title = "Class: XXX",                          path = "lua/nvim-tree/_meta/config/log.lua", },
