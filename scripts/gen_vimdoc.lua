...
---@diagnostic disable: assign-type-mismatch, incomplete-signature-doc, param-type-mismatch, undefined-doc-name, inject-field
...
local config = {
  decorator = {
    ...
    fn_helptag_fmt = function(fun)
      ...
      local common = fn_helptag_fmt_common(fun)
